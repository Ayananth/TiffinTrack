...
def apply_coupon(request):
    try:
        ...
        try:
            ...
            if (
                CouponUsage.objects.filter(user=request.user, coupon=coupon).count()
                >= coupon.usage_limit
            ):
            ...
            CouponUsage.objects.create(
                user=request.user, coupon=coupon, subscription=subscription
            )
        ...
        return _handle_view_error(request, "apply_coupon")
    ...
    try:
        ...
        try:
            ...
            CouponUsage.objects.filter(
                user=request.user, coupon=subscription.coupon, subscription=subscription_id
            ).delete()
        ...
        return _handle_view_error(request, "remove_coupon")
...
def coupon_form(request, coupon_id=None):
    try:
        ...
        return _handle_view_error(request, "coupon_form")
...
def delete_coupon(request, coupon_id):
    try:
        ...
        return _handle_view_error(request, "delete_coupon")
...
def restaurant_coupon_form(request, coupon_id=None):
    try:
        ...
        return _handle_view_error(request, "restaurant_coupon_form")
...
def restaurant_delete_coupon(request, coupon_id):
    try:
        ...
        return _handle_view_error(request, "restaurant_delete_coupon")

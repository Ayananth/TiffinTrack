...
def _handle_view_error(request, view_name, redirect_name="admin-home"):
...
def admin_login(request):
    try:
        ...
        return _handle_view_error(request, "admin_login")
...
def admin_logout(request):
    try:
        ...
        return _handle_view_error(request, "admin_logout")
...
def home(request):
    try:
        ...
        most_ordered_restaurant = (
            orders.values("restaurant__restaurant_name")
        ...
        context = {
            ...
            "most_ordered_restaurant": (
                most_ordered_restaurant["restaurant__restaurant_name"]
                if most_ordered_restaurant
                else "N/A"
            ),
            "top_restaurant_by_revenue": (
                top_restaurants[0]["restaurant__restaurant_name"]
                if top_restaurants
                else "N/A"
            ),
...
def all_users(request):
    try:
        ...
        return _handle_view_error(request, "all_users")
...
def add_users(request):
    try:
        ...
        return _handle_view_error(request, "add_users")
...
def restaurant_requests(request):
    try:
        ...
        return _handle_view_error(request, "restaurant_requests")
    ...
    try:
        ...
        if request.method == "POST":
            form = RestaurantRegisterForm(
                request.POST, request.FILES, instance=restaurant_obj
            )
            if form.is_valid():
                ...
                messages.success(
                    request, f"Restaurant {name} {'Updated' if pk else 'Created'}!"
                )
        ...
        if restaurant_obj:
            food_items = FoodItem.objects.select_related("menu_category").filter(
                restaurant=restaurant_obj
            )
    
        return render(
            request,
            "./admin_panel/add-restaurant.html",
            {"form": form, "food_items": food_items},
        )
    except Exception:
        return _handle_view_error(request, "restaurant_add_or_update")
...
def restaurant_dashboard(request, pk=None):
    try:
        ...
        return _handle_view_error(request, "restaurant_dashboard")
...
def restaurant_approve(request, pk):
    try:
        ...
        return _handle_view_error(request, "restaurant_approve")
...
def delete_restaurant(request, id):
    try:
        ...
        return _handle_view_error(request, "delete_restaurant")
...
def delete_user(request, id):
    try:
        ...
        return _handle_view_error(request, "delete_user")
...
def update_user(request, id):
    try:
        ...
        return _handle_view_error(request, "update_user")
...
def sales_report_overview(request):
    try:
        ...
        context = {
            ...
            "active_restaurants": active_restaurants,
            "most_ordered_item": (
                most_ordered_item["food_item__name"] if most_ordered_item else "N/A"
            ),
        }
    
        return render(request, "./admin_panel/dashboard.html", context)
    except Exception:
        return _handle_view_error(request, "sales_report_overview")
...
def delete_report(request, id):
    try:
        ...
        return _handle_view_error(request, "delete_report")
...
def refund_report(request, id):
    try:
        ...
        try:
            ...
            wallet.credit(
                report.order.food_category.price,
                description=f"Refund for order #{report.id}",
            )
        ...
        return _handle_view_error(request, "refund_report")
...
def reject_report(request):
    try:
        ...
        return _handle_view_error(request, "reject_report")
...
def export_dashboard_insights(request):
    try:
        ...
        most_ordered_restaurant = (
            most_ordered["restaurant__restaurant_name"] if most_ordered else "N/A"
        )
        ...
        response["Content-Disposition"] = (
            f'attachment; filename="dashboard_insights_{timezone.now().strftime("%Y-%m-%d")}.csv"'
        )
        ...
        return _handle_view_error(request, "export_dashboard_insights")

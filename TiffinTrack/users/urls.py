...
urlpatterns = [
    ...
    path("restaurant/<slug:slug>", views.restaurant_details, name="restaurant-details"),
    ...
    path(
        "orders/extend/<int:order_id>/", views.extend_subscription, name="extend_order"
    ),
    path("wallet/", views.wallet, name="wallet"),
    path("use-wallet/", views.use_wallet, name="use_wallet"),
    ...
    path("add-review/", views.post_review, name="add_review"),
    ...
    path(
        "api/coupons/<int:restaurant_id>/",
        views.available_coupons_json,
        name="restaurant_coupons",
    ),
    path(
        "invoice/<int:invoice_id>/pdf/", views.generate_invoice_pdf, name="invoice_pdf"
    ),
    path(
        "report/restaurant/<int:restaurant_id>/",

...
urlpatterns = [
    ...
    path(
        "restaurant/signup/", views.restaurant_sign_up, name="restaurant-register-auth"
    ),
    path(
        "restaurant/signup/<int:id>/",
    ...
    path(
        "request-email-change/", views.request_email_change, name="request_email_change"
    ),
    path(
        "confirm-email-change/", views.confirm_email_change, name="confirm_email_change"
    ),
    path(
        "change-password/",
    ...
    path(
        "confirm-password-change/<str:token>/",

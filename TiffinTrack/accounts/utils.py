...
def send_otp_sms():
    try:
        verification = client.verify.v2.services(
            "VAdf09a320224ebf348a443a54f1cab8ce"
        ).verifications.create(to="+919544670122", channel="sms")
        return "success"
...
def verify_otp_sms(otp):
    try:
        verification_check = client.verify.v2.services(
            ...
            to="+919544670122", code=otp
        )  # The code user enters
...
def send_templated_email(
    *,
    ...
    email = EmailMultiAlternatives(
        ...
        or getattr(settings, "DEFAULT_FROM_EMAIL", settings.EMAIL_HOST_USER),
        to=recipient_list,
    )
